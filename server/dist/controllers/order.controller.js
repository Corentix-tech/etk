...
class OrderController {
    ...
    create = async (req, res, next) => {
        try {
            ...
            const order = await this.orderService.createOrder(userId, customerDetails, items, shippingAddress);
            (0, response_1.sendSuccess)(res, { order }, 'Order initialized successfully.', 201);
        }
        catch (error) {
            next(error);
        }
    ...
    verifyPayment = async (req, res, next) => {
        try {
            ...
            const order = await this.orderService.verifyPayment(razorpayOrderId, razorpayPaymentId, razorpaySignature);
            (0, response_1.sendSuccess)(res, { order }, 'Payment verified and order confirmed.', 200);
        }
        catch (error) {
            next(error);
        }
    ...
    updateStatus = async (req, res, next) => {
        try {
            ...
            (0, response_1.sendSuccess)(res, { order }, 'Order status updated successfully.', 200);
        }
        catch (error) {
            next(error);
        }
    ...
    addTracking = async (req, res, next) => {
        try {
            ...
            (0, response_1.sendSuccess)(res, { order }, 'Tracking number assigned and order status updated.', 200);
        }
        catch (error) {
            next(error);
        }
    ...
    getInvoice = async (req, res, next) => {
        try {
            ...
            (0, response_1.sendSuccess)(res, { invoice }, 'Invoice details compiled successfully.', 200);
        }
        catch (error) {
            next(error);
        }
    ...
    getById = async (req, res, next) => {
        try {
            ...
            (0, response_1.sendSuccess)(res, { order }, 'Order retrieved successfully.', 200);
        }
        catch (error) {
            next(error);
        }
    ...
    list = async (req, res, next) => {
        try {
            ...
            (0, response_1.sendSuccess)(res, result, 'Orders retrieved successfully.', 200);
        }
        catch (error) {
            next(error);
        }
